...
object MongoFactory {
  private val DATABASE = System.getProperty("MONGO_DB", "tenii-customer")
  val uri = MongoClientURI(s"mongodb://${System.getProperty("MONGO_HOST", "localhost:27017")}/$DATABASE")
